...
const messages = {
  ...
  aboutMeParagraph: {
    id: 'aboutMeParagraph',
    defaultMessage: '&#128075; Je m\'appelle Adrien, et je suis d&eacute;veloppeur web.<br />' +
      ...
      'Mon exp&eacute;rience m\'a permis de travailler avec de multiples technologies, et actuellement je travaille chez <a href="https://unity.com/">Unity technologies</a> en tant que d&eacute;veloppeur full-stack.<br /><br />' +
      'J\'aime tous les aspects du d&eacute;veloppement web, je suis toujours pr&ecirc;t &agrave; apprendre de nouvelles choses !<br /><br />' +
      ...
      'Je serais tr&egrave;s heureux de discuter de sujets li&eacute;s au web (mais pas que) avec vous, donc n\'h&eacute;sitez pas &agrave; <a href="/#contact">me contacter</a>.<br />'
  }
